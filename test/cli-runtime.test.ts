        ...
        data: {
          ...
          pdf_ingestion: {
            ...
            issues: [{
              ...
              message: "PDF Codex agent is not ready: Local agent is not configured: codex.",
              path: ".llm-wiki/config.yml:agents.codex",
              hint: "Configure agents.codex as a Codex local-exec agent before extracting PDFs.",
            }],
          },
