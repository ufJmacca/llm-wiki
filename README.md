...
Until those features land, the supported product behavior is repo initialization, raw source capture, ingest and query task scaffolding and validation, queue/log/lint/index control-plane commands, and offline search/navigation over local Markdown.
