...
function firstQueueSourceCardMismatch(item: QueueItem, card: SourceCard): string | null {
  ...
  const fields: Array<[field: string, queueValue: unknown, cardValue: unknown]> = [
    ...
    ["uploader", item.uploader, frontmatter.uploader],
    ["upload_session_id", item.upload_session_id, frontmatter.upload_session_id],
    ["uploaded_via", item.uploaded_via, frontmatter.uploaded_via],
